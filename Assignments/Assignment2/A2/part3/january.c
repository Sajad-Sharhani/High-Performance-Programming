...
void delete(int index)
{
    ...
    // checking if the index value is not found in the linked list or the linked list is empty
    if (current == NULL || current->index != index)
    {

        return;
    } // checking if the node to be deleted is the head of the linked list
